...
export default function AccessControlPage() {
  return (
    <>
      <div className="mb-8">
        <h1 className="text-3xl font-600 text-slate-100 mb-1">Access Control</h1>
        <p className="text-sm text-slate-500">Manage access policies, permissions, and audit trails</p>
      </div>
